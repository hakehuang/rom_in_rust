...
MEMORY
{
  FLASH : ORIGIN = 0x13000000, LENGTH = 192K
  ROM_API_0 : ORIGIN = 0x13009FF8, LENGTH = 1K
  ROM_API_1 : ORIGIN = 0x1300a046, LENGTH = 0x10
  ROM_API_2 : ORIGIN = 0x1300a056, LENGTH = 1K
  ROM_API_3 : ORIGIN = 0x1303f000, LENGTH = 1K
...
SECTIONS
{
  ...
  .ROM_API_0 ORIGIN(ROM_API_0):
  {
    KEEP(*(.ROM_API_0.FSL_ROM_OTP_INIT_ADDR*));
  } > ROM_API_0

  .ROM_API_1 ORIGIN(ROM_API_1):
  {
    KEEP(*(.ROM_API_1.FSL_ROM_OTP_DEINIT_ADDR*));
  } > ROM_API_1

  .ROM_API_2 ORIGIN(ROM_API_2):
  {
    KEEP(*(.ROM_API_2.FSL_ROM_OTP_FUSE_READ_ADDR*));
  } > ROM_API_2

  .ROM_API_3 ORIGIN(ROM_API_3):
  {
    KEEP(*(.ROM_API_3.ROM_API_TABLE_ADDR*));
  } > ROM_API_3
